...
ervaring_dressuur = int(input("Hoeveel jaar praktijkervaring heeft u met dieren-dressuur? "))
            ...
            if hasDiploma == "ja":
                ...
                if hasLicense == "ja":
                    ...
                    if hasHat == "ja":
                        ...
                        hasLength = int(input("Wat is uw lengte? "))
                        if hasLength >= 150:

                            hasWeight = int(input("Wat is uw lichaamsgewicht? "))
                            if hasWeight >= 90:
                                ...
                                if hasCertificaat == "ja":
                                    ...
                                    if hasManWoman == "ja":
                                       hasSnor = int(input("Wat is uw snorbreedte? "))
                                    else: 
                                       haskrulhaar = int(input("Wat is uw krulhaarlengte? "))
                                    if hasKrulhaar >= 20:

                                        hasManWoman = hasSnor                                                                              
                                    if hasSnor >= 10:     
# Vanaf hier de 4 extra vragen   
